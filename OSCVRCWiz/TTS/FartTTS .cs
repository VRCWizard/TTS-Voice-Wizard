...
namespace TTS
{
    public class FartTTS
    {
        public static async Task FartTextAsSpeech(string text, CancellationToken ct = default)
        {
            ...
            try
           {
             ...
             //   MemoryStream memoryStream = new MemoryStream(result);
                ...
                //  memoryStream.Flush();
                //   memoryStream.Seek(0, SeekOrigin.Begin);// go to begining before copying
                WaveFileReader wav = new WaveFileReader(TheFart);


              //  memoryStream2.Flush();
            //    memoryStream2.Seek(0, SeekOrigin.Begin);// go to begining before copying
                WaveFileReader wav2 = new WaveFileReader(TheFart);
