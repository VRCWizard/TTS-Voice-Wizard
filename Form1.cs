...
namespace OSCVRCWiz
{
    public partial class Form1 : Form
    {
        ...
        static string YourSubscriptionKey = Settings1.Default.yourKey;
        static string YourServiceRegion = Settings1.Default.yourRegion;
        string dictationString = "";
        int debugDelayValue = 250;// Recommended delay of 250ms 
        ...
        public Form1()
        {
          ...
          //      comboBoxVirtualOutput.Items.Add($"{n}: {caps.ProductName}");
          //  }
            ...
            //     System.Diagnostics.Debug.WriteLine($"{n}: {caps.ProductName}");
            //  }
            // var outputDevice = new WaveOutEvent() { DeviceNumber = 2 }; not used here make global?
        ...
        private async void button1_Click(object sender, EventArgs e)//TTS
        {
            ...
            //Send Text to TTS
            Task.Run(() => SynthesizeAudioAsync(text, emotion, rate, pitch, volume, voice, audioOutputIndex));
        ...
        private async void button3_Click(object sender, EventArgs e)//speech to text
        {
            ...
            try
            {
                ...
                Task.Run(() => SynthesizeAudioAsync(dictationString, emotion, rate, pitch, volume, voice, audioOutputIndex));
            }
            catch (Exception ex)
            {
        ...
        static async Task SynthesizeAudioAsync(string text, string style, string rate, string pitch, string volume, string voice, int outputIndex) //TTS Outputs through speakers //can not change voice style
        {
            try
            {
                ...
                // selectVirtualOutputDevice(result);
                //send result to virtual cable

                // int index = audioOutputIndex;
                ...
                /* if (outputIndex != -1)
                 {
                     ...
                     var outputDevice = new WaveOutEvent() { DeviceNumber = outputIndex };
                     ...
                     //player.Init(reader);
                     // player.Play();
                     System.Diagnostics.Debug.WriteLine("this part is definitly running: " + outputIndex);
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //System.Diagnostics.Debug.WriteLine("settings: " + Settings1.Default.yourKey);
